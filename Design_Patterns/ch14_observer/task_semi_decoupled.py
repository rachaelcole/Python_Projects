# The following code shows the task_completer.py code after taking a step toward a more decoupled system. We move the 
# evaluation calculation for task completion from the Task() object to the relevant objects where it is relevant.
# However, the Task handler is changed whenever a new type of badge/credit/alert/etc is added to the system. This is
# not ideal.
