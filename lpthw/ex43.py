...
class Engine(object):
    # Give the scene map to the Engine
...
class Death(Scene):
    quips = [
        ...
        "Your ancestors would be proud... if they were smarter.",
        "You lost.",
...
class Map(object):
    ...
    # Give map an opening scene in constructor:
    def __init__(self, start_scene):
        self.start_scene = start_scene

    # Return a scene based on its name/key in the scenes array
    def next_scene(self, scene_name):
        return Map.scenes.get(scene_name)

    # Return the opening scene, which is set when the map is created
