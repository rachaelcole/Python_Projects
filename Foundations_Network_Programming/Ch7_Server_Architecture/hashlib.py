# Using hashes to assign data to servers

import hashlib


def alpha_shard(word):
    # This does a poor job of assigning data to servers, by using first letters
    if word[0] < 'g':       # abcdef
        return 'server0'
...
def md5_shard(word):
    # Assign data to servers using MD5 hash algorithm
