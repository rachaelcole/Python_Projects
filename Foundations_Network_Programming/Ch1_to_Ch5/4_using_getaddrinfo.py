# Performs an "Are you there?" test of whatever web server you name on the command line by attempting a quick
# connection to port 80 with a streaming socket
...
def connect_to(hostname_or_ip):
    ...
    info = infolist[0]  # Try the first IP address given
    ...
    else: print('Success: host', info[3], 'is listening on port 80')
