# A payments app built on Flask with basic security; login template not found error thrown
...
def index():
    ...
    return render_template('index.html', payments=payments, username=username, flash_messages=get_flashed_messages())
